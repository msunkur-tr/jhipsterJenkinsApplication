...
public class JhipsterJenkinsApplicationApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterJenkinsApplicationApp.class);

    private final Environment env;

    public JhipsterJenkinsApplicationApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterJenkinsApplicationApp.class);
